...
public class AdminController : ControllerBase
{
    ...
    public AdminController(AppDbContext _appDbContext, UserManager<ApplicationUser> _userManager, IMapper _mapper, RoleManager<IdentityRole> _roleManager)
    {
    ...
    public async Task<ActionResult<PaginatedItemsDto<ApplicationUserDto>>> GetMany([FromQuery] int page = 1, [FromQuery] int limit = 10)
    {
        ...
        var totalItems = await userManager.Users.Where(u => u.Role == UserRole.ADMIN).CountAsync();
    ...
    public async Task<ActionResult<ApplicationUserDto>> CreateOne(CreateUserDto user)
    {
    ...
    [HttpPut()]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<ApplicationUserDto>> UpdateOne(UpdateUserDto user)
    {
        ...
        foundUser.PhoneNumber = "xx xxx xxx";
